...
<body>
  ...
  <script type="text/javascript">
    function mostrar() {
      swal("Bien!", "Dato ingresado correctamente!, Fue enviado", "success");
    }
  </script>
    ...
    <div class="row justify-content-center">
      <div class="col-md-4 my-4">
        <form class="bg-light rounded p-2 ml-lg-4 p-md-4" action="" method="post" autocomplete="off">
          ...
          <button onclick="mostrar()" type="submit" class="btn btn-primary" name="submit" style="background:blue;">Enviar</button>
        </form>
      </div>
    </div>
  </section>
