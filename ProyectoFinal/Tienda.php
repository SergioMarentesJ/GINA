...
<body>
  ...
  <br><br><br><br>
          ...
          <?php
              ...
              $descuento = "SELECT * FROM productos WHERE idp= $random";
              $correr = mysqli_query($con, $descuento);
              while ( $fila = mysqli_fetch_array($correr)) {
                $nod = $fila['nom'];
                $prd = $fila['pre'];
                $imd = $fila['image'];
              }
      ...
      <section class="container text-light mt-5 rounded text-center">
        <div class="row justify-content-center">
            ...
            <div>
              <h1 style="color: white;"><?php echo $nod ?></h1>
              <img style="width: 200px; height: 250px;" src=images/<?php echo $imd; ?>>
              <h3 style="color: white;"> DE: $ <?php echo $prd ?> A TAN SOLO: $<?php echo $prd - $rebaja ?> </h3>
            </div>
        </div>
        <div class="row pb-5">
            ...
            <div class="contain">
              ...
              <div class="col social">
                ...
                <div class="flex footer-social">
                  <ul>
                    <li><a href="#" rel="noopener" target="_blank"><svg aria-hidden="true" focusable="false" role="presentation" viewBox="0 0 32 32" width="24" height="24">
                          <path fill="#ffffff" d="M18.222 11.556V8.91c0-1.194.264-1.799 2.118-1.799h2.326V2.667h-3.882c-4.757 0-6.326 2.181-6.326 5.924v2.965H9.333V16h3.125v13.333h5.764V16h3.917l.528-4.444h-4.444z"></path>
                        </svg></a></li>
                    <li><a href="#" rel="noopener" target="_blank"><svg aria-hidden="true" focusable="false" role="presentation" viewBox="0 0 32 32" width="24" height="24">
                          <path fill="#ffffff" d="M16 2C8.269 2 2 8.269 2 16c0 5.731 3.45 10.656 8.381 12.825-.037-.975-.006-2.15.244-3.212l1.8-7.631s-.45-.894-.45-2.213c0-2.075 1.2-3.625 2.7-3.625 1.275 0 1.887.956 1.887 2.1 0 1.281-.819 3.194-1.238 4.969-.35 1.488.744 2.694 2.212 2.694 2.65 0 4.438-3.406 4.438-7.444 0-3.069-2.069-5.362-5.825-5.362-4.244 0-6.894 3.169-6.894 6.706 0 1.219.363 2.081.925 2.744.256.306.294.431.2.781-.069.256-.219.875-.287 1.125-.094.356-.381.481-.7.35-1.956-.8-2.869-2.938-2.869-5.35 0-3.975 3.356-8.744 10.006-8.744 5.344 0 8.863 3.869 8.863 8.019 0 5.494-3.056 9.594-7.556 9.594-1.512 0-2.931-.819-3.419-1.744 0 0-.813 3.225-.988 3.85-.294 1.081-.875 2.156-1.406 3 1.256.369 2.588.575 3.969.575 7.731 0 14-6.269 14-14 .006-7.738-6.262-14.006-13.994-14.006z"></path>
                        </svg></a></li>
                    <li><a href="https://www.instagram.com/silkyropa/" rel="noopener" target="_blank"><svg aria-hidden="true" focusable="false" role="presentation" viewBox="0 0 512 512" width="24" height="24">
                          ...
                          <path fill="#ffffff" d="M256 126.6c-71.4 0-129.4 57.9-129.4 129.4s58 129.4 129.4 129.4 129.4-58 129.4-129.4-58-129.4-129.4-129.4zm0 213.4c-46.4 0-84-37.6-84-84s37.6-84 84-84 84 37.6 84 84-37.6 84-84 84z"></path>
                          <circle fill="#ffffff" cx="390.5" cy="121.5" r="30.2"></circle>
                        </svg></a></li>
                  </ul>
                </div>
              </div>
